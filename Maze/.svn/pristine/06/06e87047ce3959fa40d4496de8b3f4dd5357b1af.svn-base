...
public interface Viewer {
	 ...
	 */
	//public void redraw(Graphics gc, int state, int px, int py, int view_dx, int view_dy, int walk_step, int view_offset, RangeSet rset, int ang, boolean stopped) ;
	public void redraw(GraphicsWrapper graphics, int state, int px, int py, int view_dx, int view_dy, int walk_step, int view_offset, RangeSet rset, int ang, boolean stopped);
	/** 
