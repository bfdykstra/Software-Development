...
public class Maze  {
	...
	ManualDriver rd; //driver reference
	 ...
	 */
	protected void build(int skill) throws Exception {
		// switch screen
	...
	protected void newBuild(int skill, int driver, int genMethod) throws Exception {
		// switch screen
		state = Constants.STATE_GENERATING;
		percentdone = 0;
		notifyViewerRedraw() ;
		...
		//0 = manual, 1 = wallfollower, 2 = mouse, 3 = wizard
		...
		case 3:
			...
			this.robot.setMaze(this);
			this.robot.setBatteryLevel(2500);
			//System.out.println("This is in maze.build(). This is the mazedists being passed to the driver: "+ this.mazedists);
			//setUpDriver(this.mazew, this.mazeh, this.mazedists, this.robot);
			break;
		}
		*/
	...
	private void setUpDriver(int width, int height, Distance dist, Robot r){
