...
public class MapDrawer extends DefaultViewer {
	...
	public void redraw(GraphicsWrapper gc, int state, int px, int py,
			int view_dx, int view_dy, int walk_step, int view_offset, RangeSet rset, int ang, boolean stopped) {
		//dbg("redraw") ;
	...
	public void draw_map(GraphicsWrapper gc, int px, int py, int walk_step, int view_dx, int view_dy, boolean showMaze, boolean showSolution) {
		...
		for (int y = ymin; y <= ymax; y++)
			for (int x = xmin; x <= xmax; x++) {
				...
				gc.setColor(seencells.hasWallOnTop(x, y) ? gwColor.white : gwColor.gray);
				...
				gc.setColor(seencells.hasWallOnLeft(x, y) ? gwColor.white : gwColor.gray);
